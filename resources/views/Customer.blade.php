            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  <li class="nav-item"><a class="nav-link active" href="#activity" data-toggle="tab">Data Master Customer</a></li>
              ...
              <div class="card-body">
                <div class="tab-content">
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Form Edit Customer</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                            </button>
                          </div>
                          <div class="modal-body">
                            <form class="form-horizontal" id="frm-edit" name="frm-edit" method="POST" action="{{ route('edit.master.customer') }}">
                              @csrf
                              <div class="form-group">
                                <label for="recipient-name" class="col-form-label">Kode Customer</label>
                                <input name="edit_kd_customer" class="form-control" id="edit_kd_customer" readonly>
                              </div>
                              <div class="form-group">
                                <label for="recipient-name" class="col-form-label">Nama Customer</label>
                                <input name="edit_nama_customer" type="text" class="form-control" id="edit_nama_customer" required>
                              </div>
                              <div class="form-group">
                                <label for="recipient-name" class="col-form-label">Alamat</label>
                                <input name="edit_alamat_customer" type="text" class="form-control" id="edit_alamat_customer" required>
                              </div>
                              <div class="form-group">
                                <label for="recipient-name" class="col-form-label">No. HP</label>
                                <input name="edit_nohp_customer" type="text" class="form-control" id="edit_nohp_customer" required>
                              </div>
                              <div class="form-group">
                                <label for="recipient-name" class="col-form-label">E-mail</label>
                                <input name="edit_email_customer" type="text" class="form-control" id="edit_email_customer" required>
                              </div>
                          </div>
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <form class="form-horizontal" id="frm-edit" name="frm-edit" method="POST" action="{{ route('hapus.master.customer') }}">
                              @csrf
                                <input name="hapus_kd_customer" type="hidden" class="form-control" id="hapus_kd_customer" readonly>
                          </div>
                          <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Kembali</button>
                  ...
                  <div class="tab-pane" id="settings">                  
                    <form class="form-horizontal" id="frm-input" name="frm_input" method="POST" action="{{ route('input.master.customer') }}">
                    <?php
                    ...
                    ?>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                          <input type="text" name="kd_customer" id="kd_customer" class="form-control" value="{{ old('kd_customer', $kd_customer) }}" readonly>
                        </div>
                      </div>
                      <div class="form-group row">
