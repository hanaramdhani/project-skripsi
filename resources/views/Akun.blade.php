            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  <li class="nav-item"><a class="nav-link active" href="#activity" data-toggle="tab">Data Master Akun</a></li>
              ...
              <div class="card-body">
                <div class="tab-content">
                          ...
                          <tr class="data-row">
                            ...
                            <td class="text-center">
                              <button 
                                    ...
                                    data-nama-akun="<?= $value->nama ?>"
                                    data-status-akun="<?= $value->status ?>"
                                    data-keterangan-akun="<?= $value->keterangan ?>"
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form class="form-horizontal" id="frm-edit" name="frm-edit" method="POST" action="{{ route('edit.master.akun') }}">
                              @csrf
                              <div class="form-group">
                                <label for="recipient-name" class="col-form-label">Kode Akun</label>
                                <input name="edit_kd_akun" class="form-control" id="edit_kd_akun" readonly>
                              </div>
                              <div class="form-group">
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <form class="form-horizontal" id="frm-edit" name="frm-edit" method="POST" action="{{ route('hapus.master.akun') }}">
                              @csrf
                                <input name="hapus_kd_akun" type="hidden" class="form-control" id="hapus_kd_akun" readonly>
                          </div>
                          <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Kembali</button>
                  ...
                  <div class="tab-pane" id="settings">                  
                    <form class="form-horizontal" id="frm-input" name="frm_input" method="POST" action="{{ route('input.master.akun') }}">
                    <?php
                    ...
                    ?>
                      ...
                      <div class="form-group row">
                        <label for="inputName2" class="col-sm-2 col-form-label">Kode Akun</label>
                        <div class="col-sm-5">
                          <input type="text" name="kd_akun" id="kd_akun" class="form-control" value="{{ old('kd_akun', $kd_akun) }}" readonly>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputName2" class="col-sm-2 col-form-label">Nama Akun</label>
                        <div class="col-sm-5">
...
<script>
  ...
  $('#example2 tbody').on('click', '.edit-data', function () {
        ...
        let status = $(this).data('status-akun');
        let keterangan = $(this).data('keterangan-akun');
        $('#edit_kd_akun').val(kd_akun);
        $('#edit_nama_akun').val(nama_akun);
        $('#edit_status_akun').val(status);
        $('#edit_keterangan_akun').val(keterangan);
  });

  $('#example2 tbody').on('click', '.hapus-data', function () {
        let kd_akun = $(this).data('kd-akun');
        $('#hapus_kd_akun').val(kd_akun);
  });
