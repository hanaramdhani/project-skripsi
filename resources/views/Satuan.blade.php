            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  <li class="nav-item"><a class="nav-link active" href="#activity" data-toggle="tab">Data Master Satuan</a></li>
              ...
              <div class="card-body">
                <div class="tab-content">
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form class="form-horizontal" id="frm-edit" name="frm-edit" method="POST" action="{{ route('edit.master.satuan') }}">
                              @csrf
                              <div class="form-group">
                                <label for="recipient-name" class="col-form-label">Kode Satuan</label>
                                <input name="edit_kd_satuan" class="form-control" id="edit_kd_satuan" readonly>
                              </div>
                              <div class="form-group">
                                <label for="recipient-name" class="col-form-label">Nama Satuan</label>
                                <input name="edit_nama_satuan" type="text" class="form-control" id="edit_nama_satuan" required>
                              </div>
                              <div class="form-group">
                                <label for="recipient-name" class="col-form-label">Keterangan</label>
                                <input name="edit_keterangan_satuan" type="text" class="form-control" id="edit_keterangan_satuan" required>
                              </div>
                              <div class="form-group">
                                <label for="recipient-name" class="col-form-label">Status</label>
                                <select name="edit_status_satuan" class="form-control" id="edit_status_satuan" required>
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <form class="form-horizontal" id="frm-edit" name="frm-edit" method="POST" action="{{ route('hapus.master.satuan') }}">
                              @csrf
                  ...
                  <div class="tab-pane" id="settings">                  
                    <form class="form-horizontal" id="frm-input" name="frm_input" method="POST" action="{{ route('input.master.satuan') }}">
                    <?php
                    ...
                    ?>
                      ...
                      <div class="form-group row">
                        <label for="inputName2" class="col-sm-2 col-form-label">Kode Satuan</label>
                        <div class="col-sm-5">
                          <input type="text" name="kd_satuan" id="kd_satuan" class="form-control" value="{{ old('kd_satuan', $kd_satuan) }}" readonly>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputName2" class="col-sm-2 col-form-label">Nama Satuan</label>
                        <div class="col-sm-5">
